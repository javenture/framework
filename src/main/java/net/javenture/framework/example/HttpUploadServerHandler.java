...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject>
{
	...
	{
		System.out.println("channelRead0");                   // XXX
				...
				try
				{
						...
						if (data != null)
						{
							...
							try
							{
								...
								else
								{
									...
									{
										FileUpload fileUpload = (FileUpload) data;  //fileUpload.getFilename()

										if (fileUpload.isCompleted())
										{
											if (fileUpload.length() < 10000)                               // XXX
											{
					...
					if (data != null)
					{
						...
						if (partialContent == null)
						{
							...
							{
								builder
									.append("Start Attribute: ")
									.append(partialContent.getName())
									.append(" ");
							}

							builder
								.append("(DefinedSize: ")
								.append(partialContent.definedLength())
								.append(")");
						}
	...
	private void writeMenu(ChannelHandlerContext context)
	{
		...
		response.headers().set(HttpHeaderNames.CONTENT_TYPE, "text/html; charset=UTF-8");                              // XXX: content-encoding ?
		response.headers().setInt(HttpHeaderNames.CONTENT_LENGTH, buf.readableBytes());

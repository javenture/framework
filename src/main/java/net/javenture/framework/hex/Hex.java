 ...
 */
@Immutable
final public class Hex
	implements IHex<byte[], Hex>
{
	//
	final public static IInstanceFactory<Hex> FACTORY_INSTANCE = object -> object instanceof Hex;
	final public static ICopyFactory<Hex> FACTORY_COPY = object -> object;

	final public static IByteFactory<Hex> FACTORY_BYTE = new IByteFactory<>()
	{
		@Override
		public void toStream(@NullAllow Hex object, OutputStream destination)
			throws Exception
		{
		...
		@Override
		public @NullAllow Hex fromStream(InputStream source)
			throws Exception
		{
			return IByteFactory.getNullHeader(source)
				? new Hex(ByteArrayUtil.FACTORY_BYTE.fromStream(source), true)
				: null;
		}
	};

	final public static IStringFactory<Hex> FACTORY_STRING = new IStringFactory<>()
	{
		@Override
		public @NullDisallow String toString(@NullAllow Hex object)
		{
			return StringUtil.toString(object);
		}

		@Override
		public Parser parser(@NullAllow Hex init, boolean nullable, boolean trim)
		{
			return new Parser(init, nullable, trim);
		}
	};

	final public static IMurmur3HashFactory<Hex> FACTORY_MURMUR3HASH = (object, destination) ->
	{
	...
	final public static IDatabaseFactory<Hex, byte[]> FACTORY_DATABASE = new IDatabaseFactory<>()
	{
		@Override
		...
		@Override
		public @NullAllow byte[] toDatabase(@NullAllow Hex object)
		{
			return object != null ? object.ARRAY : null;
		}

		@Override
		public @NullAllow Hex fromDatabase(@NullAllow byte[] object)
		{
			return object != null ? new Hex(object, true) : null;
		}
	};

	final public static Factories<Hex> FACTORIES = new Factories<>(FACTORY_INSTANCE, FACTORY_COPY, FACTORY_BYTE, FACTORY_STRING, FACTORY_MURMUR3HASH, FACTORY_DATABASE);
	...
	//
	public Hex(@NullDisallow byte[] value)
	{
		this(value, false);
	}


	private Hex(@NullDisallow byte[] array, boolean wrap)
	{
	...
	//
	@Override
	public Factories<Hex> factories()
	{
		return FACTORIES;
	}
	...
	{
		return equals((Hex) object);
	}


	@Override
	public boolean equals(@NullAllow Hex object)
	{
		return
			this == object
			||
	...
	@Override
	public @NullDisallow byte[] value()
	{
		return ARRAY.clone();
	}
	...
	//
	public static Hex wrap(byte[] array)
	{
		return new Hex(array, true);
	}
	...
	public static String toString(byte[] value, boolean capitalize)
	{
		return new String(HexUtil.convert(value, capitalize));
	}


	//
	final public static class DatabaseField
		extends AFactoryObjectDatabaseField<Hex>
	{
		//
		final private Model MODEL;

		//
		public DatabaseField(String table, int number, String name, @NullAllow Hex init, Option... options)
		{
	...
	final public static class Model
		extends AFactoryObjectModel<Hex>
	{
		//
		...
		public Model(@NullDisallow String name, boolean nullable, boolean quotation, boolean trim, @NullAllow Hex init, @NullDisallow String... objects)
		{
		...
		@Override
		public @NullDisallow IScriptEntry toScriptEntry(@NullAllow Hex value)
		{
		...
		@Override
		public @NullDisallow IParser.Report<Hex> parse(@NullAllow CharSequence source)
		{
			return PARSER.parse(source);
		}

		@Override
		public @NullDisallow IParser.Report<Hex> parse(@NullAllow JsonObject source)
		{
			if (source != null)
			{
	...
	final public static class Parser
		implements IParser<Hex>
	{
		//
		final private @NullAllow Hex INIT;
		final private boolean NULLABLE;
		final private boolean TRIM;
		final private Report<Hex> REPORT_INIT;
		final private Report<Hex> REPORT_ERROR;
		final private Report<Hex> REPORT_NULL;

		//
		public Parser(@NullAllow Hex init, boolean nullable, boolean trim)
		{
		...
		@Override
		public Report<Hex> parse(@NullAllow Hex value)
		{
			if (value != null)
			{
		...
		@Override
		public Report<Hex> parse(@NullAllow CharSequence source)
		{
			if (source != null)
			{
				if (!NULLABLE || NullUtil.notNull(source, TRIM))
				{
					...
					if (bytes != null)
					{
						return INIT == null || !ByteArrayUtil.equal(bytes, INIT.ARRAY)
							? new Report<>(true, true, new Hex(bytes, true))
							: REPORT_INIT;
					}
				}
				else
		...
		//
		final public static Parser BLANK = new Parser(Hex.BLANK, false, false);
		final public static Parser NULL = new Parser(null, true, false);
	}


	//
	final public static Hex BLANK = new Hex(ByteArrayUtil.BLANK);

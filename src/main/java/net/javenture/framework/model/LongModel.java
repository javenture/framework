	...
	extends AModel<Long>
{
	...
	//
	public LongModel(@NullDisallow LongDatabaseField field, boolean quotation, boolean trim)
	{
		super(field);

		Long init = field.init();
		...
		TRIM = trim;
		INIT = init;
		PARSER = new LongParser(init, nullable, trim);
	}


	public LongModel(@NullDisallow String name, boolean nullable, boolean quotation, boolean trim, @NullAllow Long init, @NullDisallow String... objects)
	{
		super(name, objects);
	...
	{
		return INIT != null
			? new LongScriptValue(INIT, QUOTATION)
			: NullScriptValue.INSTANCE;
	}


	@Override
	public @NullDisallow IScriptEntry toScriptEntry(@NullAllow Long value)
	{
		Validator.argument(NULLABLE || value != null, "[value] null value disallowed");

		return value != null
			? new LongScriptValue(value, QUOTATION)
			: NullScriptValue.INSTANCE;
	}
	...
	@Override
	public void toNettyParameter(@NullAllow Long value, NettyParameters destination)
	{
		Validator.argument(NULLABLE || value != null, "[value] null value disallowed");
	...
	@Override
	public @NullDisallow IParser.Report<Long> parse(@NullAllow CharSequence source)
	{
	...
	@Override
	public @NullDisallow IParser.Report<Long> parse(@NullAllow JsonObject source)
	{
		if (source != null)
		{

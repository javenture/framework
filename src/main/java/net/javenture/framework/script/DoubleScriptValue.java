...
/*
	2019/07/19
 */
final public class DoubleScriptValue
	extends AScriptValue
{
	//
	final private @NullAllow Double VALUE;
	final private boolean QUOTATION;


	//
	public DoubleScriptValue(double value)
	{
		VALUE = value;
		QUOTATION = false;
	}
	...
	public DoubleScriptValue(@NullAllow Double value)
	{
		VALUE = value;
		QUOTATION = false;
	}
	...
	public DoubleScriptValue(double value, boolean quotation)
	{
		VALUE = value;
		QUOTATION = quotation;
	}
	...
	public DoubleScriptValue(@NullAllow Double value, boolean quotation)
	{
		VALUE = value;

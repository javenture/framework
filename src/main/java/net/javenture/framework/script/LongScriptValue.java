...
/*
	2019/07/19
 */
final public class LongScriptValue
	extends AScriptValue
{
	//
	final private @NullAllow Long VALUE;
	final private boolean QUOTATION;


	//
	public LongScriptValue(long value)
	{
		VALUE = value;
		QUOTATION = false;
	}
	...
	public LongScriptValue(@NullAllow Long value)
	{
		VALUE = value;
		QUOTATION = false;
	}
	...
	public LongScriptValue(long value, boolean quotation)
	{
		VALUE = value;
		QUOTATION = quotation;
	}
	...
	public LongScriptValue(@NullAllow Long value, boolean quotation)
	{
		VALUE = value;
